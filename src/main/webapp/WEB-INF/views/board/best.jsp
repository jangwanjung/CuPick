...
<div class="container" style="width: 1000px ; height: 650px">
    <div class="d-flex justify-content-between align-items-center mb-3" style="margin-top: 15px">
        <div>
            <button class="btn tab-button active" onclick="location.href='/board/best'"  style="background-color: #FDF1F1" >인기 게시물</button>
            <button class="btn tab-button" onclick="location.href='/board'">최신 게시물</button>
        </div>
        <div>
